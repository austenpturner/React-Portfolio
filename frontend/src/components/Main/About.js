    ...
    return (
      <div id="about">
          ...
          <div id="text-container">
              <p data-aos='fade-up'> 
                  I'm Austen, a web developer based in Seattle, WA. I build and design websites and apps. My projects combine a polished and responsive client-side with an efficient server-side. I take pride in writing clean, organized and well-documented code that lends to user-friendly applications. 
              </p>
              <p data-aos='fade-up'>
